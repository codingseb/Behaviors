...
namespace CodingSeb.Behaviors
{
    ...
    #region ExpressionEvaluator linked internal classes (specific Exceptions and EventArgs)

    internal class ExpressionEvaluatorSyntaxErrorException : Exception
    {
    ...
    internal class ExpressionEvaluatorSecurityException : Exception
    {
